...
const FIELD_DEFINITIONS: FieldDefinition[] = [
  ...
  { recordKind: 'program', fieldPath: 'duration_unit', valueType: 'string', riskClass: 'medium', requiredForPublish: false, maxAgeDays: 30, validationProfile: 'duration-unit' },
  ...
  { recordKind: 'program_cycle', fieldPath: 'starts_on', valueType: 'date', riskClass: 'critical', requiredForPublish: false, maxAgeDays: 7, validationProfile: 'iso-date' },
  { recordKind: 'program_cycle', fieldPath: 'ends_on', valueType: 'date', riskClass: 'critical', requiredForPublish: false, maxAgeDays: 7, validationProfile: 'iso-date' },
  { recordKind: 'program_cycle', fieldPath: 'cycle_status', valueType: 'string', riskClass: 'critical', requiredForPublish: false, maxAgeDays: 7, validationProfile: 'cycle-status' },
  ...
  { recordKind: 'application_route', fieldPath: 'route_type', valueType: 'string', riskClass: 'critical', requiredForPublish: false, maxAgeDays: 30, validationProfile: 'application-route-type' },
  ...
  { recordKind: 'application_window', fieldPath: 'round_label', valueType: 'string', riskClass: 'high', requiredForPublish: false, maxAgeDays: 7, validationProfile: 'non-empty-text' },
  ...
  { recordKind: 'fee', fieldPath: 'amount_max_minor', valueType: 'decimal_minor', riskClass: 'critical', requiredForPublish: false, maxAgeDays: 7, validationProfile: 'non-negative-integer' },
  ...
  { recordKind: 'fee', fieldPath: 'billing_period', valueType: 'string', riskClass: 'critical', requiredForPublish: false, maxAgeDays: 7, validationProfile: 'billing-period' },
  { recordKind: 'fee', fieldPath: 'value_status', valueType: 'string', riskClass: 'critical', requiredForPublish: false, maxAgeDays: 7, validationProfile: 'fee-value-status' },
  { recordKind: 'requirement', fieldPath: 'requirement_type', valueType: 'string', riskClass: 'critical', requiredForPublish: false, maxAgeDays: 30, validationProfile: 'requirement-type' },
  { recordKind: 'requirement', fieldPath: 'comparator', valueType: 'string', riskClass: 'critical', requiredForPublish: false, maxAgeDays: 30, validationProfile: 'requirement-comparator' },
  { recordKind: 'requirement', fieldPath: 'value_json', valueType: 'json', riskClass: 'critical', requiredForPublish: false, maxAgeDays: 30, validationProfile: 'json-value' },
  { recordKind: 'requirement', fieldPath: 'required', valueType: 'boolean', riskClass: 'critical', requiredForPublish: false, maxAgeDays: 30, validationProfile: 'boolean' },
  { recordKind: 'requirement', fieldPath: 'applies_to_json', valueType: 'json', riskClass: 'critical', requiredForPublish: false, maxAgeDays: 30, validationProfile: 'json-value' },
  ...
  { recordKind: 'scholarship_cycle', fieldPath: 'intake_code', valueType: 'string', riskClass: 'critical', requiredForPublish: true, maxAgeDays: 30, validationProfile: 'intake-code' },
  { recordKind: 'scholarship_cycle', fieldPath: 'cycle_status', valueType: 'string', riskClass: 'critical', requiredForPublish: false, maxAgeDays: 7, validationProfile: 'cycle-status' },
