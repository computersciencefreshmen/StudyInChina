...
| **266** 所高校 | **1,255** 个项目身份 | **364** 项奖学金身份 | **62** 座城市 |
| :------------: | :------------------: | :------------------: | :-----------: |

</div>

截至 **2026-08-25**，当前公开身份目录包含 **37** 条公开招生周期记录，并由 **2,087** 条已登记官方来源记录支撑；其中只有 **6** 个项目身份处于开放、即将开放或滚动招生状态。“公开周期”不等于“正在开放申请”。目录保留可发现的已核验或 `stale` 身份；下方质量分数卡则单独衡量当前新鲜证据。项目身份、招生动态、费用、要求和奖学金资格属于不同数据层，不能用一条总数混为一谈。
...
| 通过身份发布门禁的国际生项目       | 1,255 / 1,255 · **100%** |                     保持 100% |
| 30 天内有新鲜处置结论的项目        |     37 / 1,255 · **2.95%** |                           ≥ 70% |
| 有明确日期或滚动招生语义的项目     |     37 / 1,255 · **2.95%** |          如实报告，不用猜测补齐 |
| 评估日开放、即将开放或滚动招生的项目 |      6 / 1,255 · **0.48%** |        如实报告，不用旧日期抬高 |
| 已知学制的项目                     |   777 / 1,255 · **61.91%** |                           ≥ 90% |
| 有官方申请入口的项目               |   644 / 1,255 · **51.31%** |                           ≥ 80% |
| 已知授课语言的项目                 | 1,066 / 1,255 · **84.94%** |                           ≥ 95% |
| 有资格或语言要求证据的项目         |     92 / 1,255 · **7.33%** |                           ≥ 50% |
| 关联至少一项新鲜核验奖学金的高校   |     205 / 266 · **77.07%** |                        ≥ 230 所 |
| 有明确截止日的新鲜奖学金           |      37 / 348 · **10.63%** |                持续补齐当前周期 |
...
原始兼容数据集包含 272 所高校、1,275 个项目和 390 项奖学金。草稿、归档记录、身份冲突记录或尚不满足公开条件的候选，会被有意排除在上述公开数字之外。数据少于预期时，优先意味着系统在拒绝猜测，而不是把空白伪装成事实。

公开 Release API 与分数卡的身份口径一致，均为 **1,255** 个项目身份和 **364** 项奖学金身份；分数卡再单独衡量更小的当前新鲜证据子集。身份总数不能替代当前周期完整度，更不能被解释为“都在开放申请”。
...
- 将新鲜处置覆盖率从 2.95% 提升到至少 70%，不把无日期学费参考计为招生周期。
- 从当前实测的 61.91% 学制、51.31% 官方申请入口、84.94% 授课语言和 7.33% 要求信息，先达到六周门槛 75% / 65% / 90% / 25%，再向 90% / 80% / 95% / 50% 的扩展门槛推进。
