...
| **266** 所高校 | **1,260** 个项目身份 | **367** 项奖学金身份 | **62** 座城市 |
| :------------: | :------------------: | :------------------: | :-----------: |
...
| 通过身份发布门禁的国际生项目       | 1,260 / 1,260 · **100%** |                     保持 100% |
| 30 天内有新鲜处置结论的项目        |     39 / 1,260 · **3.10%** |                           ≥ 70% |
| 有明确日期或滚动招生语义的项目     |     39 / 1,260 · **3.10%** |          如实报告，不用猜测补齐 |
| 评估日开放、即将开放或滚动招生的项目 |      6 / 1,260 · **0.48%** |        如实报告，不用旧日期抬高 |
| 已知学制的项目                     |   791 / 1,260 · **62.78%** |                           ≥ 90% |
| 有官方申请入口的项目               |   656 / 1,260 · **52.06%** |                           ≥ 80% |
| 已知授课语言的项目                 | 1,073 / 1,260 · **85.16%** |                           ≥ 95% |
| 有资格或语言要求证据的项目         |     113 / 1,260 · **8.97%** |                           ≥ 50% |
| 关联至少一项新鲜核验奖学金的高校   |     206 / 266 · **77.44%** |                        ≥ 230 所 |
| 有明确截止日的新鲜奖学金           |      38 / 349 · **10.89%** |                持续补齐当前周期 |
...
公开 Release API 与分数卡的身份口径一致，均为 **1,260** 个项目身份和 **367** 项奖学金身份；分数卡再单独衡量更小的当前新鲜证据子集。身份总数不能替代当前周期完整度，更不能被解释为“都在开放申请”。
...
这些状态现在会直接显示在六语项目卡中。旧周期或仅供参考的值不能在项目卡上作为当前学费、截止日期、学制或申请费出现；申请者仍可进入官方入口做最终核验。详情与比较界面将逐步统一到同一事实契约。
...
- 将新鲜处置覆盖率从 3.10% 提升到至少 70%，不把无日期学费参考计为招生周期。
- 从当前实测的 62.78% 学制、52.06% 官方申请入口、85.16% 授课语言和 8.97% 要求信息，先达到六周门槛 75% / 65% / 90% / 25%，再向 90% / 80% / 95% / 50% 的扩展门槛推进。
- 将关联新鲜核验奖学金的高校从 206 所提升到至少 230 所，并补充真实年度、资助类型、适用范围和截止日期证据。
