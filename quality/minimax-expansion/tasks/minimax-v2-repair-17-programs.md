# MiniMax v2 repair task: minimax-v2-repair-17-programs

## Locked parameters

- TASK_ID: minimax-v2-repair-17-programs
...
- Admissions home: https://studyheu.hrbeu.edu.cn/

## Output

- quality/minimax-expansion/inbox/minimax-v2-repair-17-programs.json
- quality/minimax-expansion/inbox/minimax-v2-repair-17-programs.md

After completion:

```bash
npx tsx scripts/ingestion/validate-minimax-expansion.ts --task minimax-v2-repair-17-programs
```
