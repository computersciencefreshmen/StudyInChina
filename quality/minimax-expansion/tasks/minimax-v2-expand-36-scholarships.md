# MiniMax v2 expand-scholarship task: minimax-v2-expand-36-scholarships

## Locked parameters

- TASK_ID: minimax-v2-expand-36-scholarships
...
- Official domain (assumed): smu.edu.cn

## Output

- quality/minimax-expansion/inbox/minimax-v2-expand-36-scholarships.json
- quality/minimax-expansion/inbox/minimax-v2-expand-36-scholarships.md

After completion:

```bash
npx tsx scripts/ingestion/validate-minimax-expansion.ts --task minimax-v2-expand-36-scholarships
```
