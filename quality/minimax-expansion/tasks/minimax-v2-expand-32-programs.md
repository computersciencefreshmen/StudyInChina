# MiniMax v2 expand task: minimax-v2-expand-32-programs

## Locked parameters

- TASK_ID: minimax-v2-expand-32-programs
...
- quality/minimax-expansion/inbox/minimax-v2-expand-32-programs.json
- quality/minimax-expansion/inbox/minimax-v2-expand-32-programs.md

After completion:

```bash
npx tsx scripts/ingestion/validate-minimax-expansion.ts --task minimax-v2-expand-32-programs
```
