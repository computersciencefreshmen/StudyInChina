# MiniMax v2 expand task: minimax-v2-expand-17-programs

## Locked parameters

- TASK_ID: minimax-v2-expand-17-programs
...
- quality/minimax-expansion/inbox/minimax-v2-expand-17-programs.json
- quality/minimax-expansion/inbox/minimax-v2-expand-17-programs.md

After completion:

```bash
npx tsx scripts/ingestion/validate-minimax-expansion.ts --task minimax-v2-expand-17-programs
```
